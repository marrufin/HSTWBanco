...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                    <div class="pull-left">
                        <button type="button" class="btn btn-default btn-flat" data-toggle="modal" data-target="#modal-user">Perfil</button>
                      </div>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2019 <a href="javascript:void(0)" class="text-uppercase">HSTW</a>.</strong> Todos los derechos reservados.
    </footer> 
